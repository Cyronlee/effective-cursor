...
@prds/feature-a/final.md     # Reference requirement doc
```
...
```
@prds/user-auth/final.md Implement user authentication according to this solution
@prds/user-auth/api-spec.md Implement the API following this specification
```
...
**Feature Under Exploration**

Our team hasn't adopted Cursor Memory at scale yet. Below is our preliminary exploration.
</Callout>
...
|-----------|-------|--------|
| Storage location | Project `.cursor/rules/` | Cursor cloud |
| Sharing scope | Team (via Git) | Personal |
| Management | File-based | AI auto-managed |
| Use case | Project standards | Personal preferences |

<Callout type="info">
**Our recommendation:** Use Rules for project standards (version controlled, team shared), Memory for personal preferences.
</Callout>
