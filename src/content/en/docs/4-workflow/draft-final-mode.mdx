...
<ChatExample>
{`@specs/001-order-export/draft.md 
Based on this requirement draft, combined with the project's existing tech stack and code structure,
generate a detailed technical solution, output to @specs/001-order-export/final.md`}
</ChatExample>
...
<ChatExample>
{`@specs/001-order-export/final.md 
...
Our Draft-Final workflow embodies the principles of Spec-Driven Development (SDD) without relying on external frameworks. Learn more about [Why No Spec Framework](./why-no-spec-framework) and how we've adapted these principles to our enterprise context.

Then, let's see how to integrate all modes into a complete [Workflow Practice](./workflow-practice).
