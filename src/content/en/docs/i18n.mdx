...
The language file structure is as follows (using [`en.ts`](https://github.com/Cyronlee/effective-cursor/blob/main/src/i18n/en.ts) as an example):
...
export function SetupHero() {
  ...
  return (
    <div>
      <a href="https://github.com/Cyronlee/effective-cursor">
        {t('badgeTitle')}
      </a>
