...
Mark AI assistance information in Git commits:
...
ai_assisted=$(git log --grep="AI-Assisted: true" --since="1 month ago" --oneline | wc -l)

echo "Total commits: $total"
echo "AI-assisted commits: $ai_assisted"
echo "AI assistance ratio: $(echo "scale=2; $ai_assisted * 100 / $total" | bc)%"
```

#### IDE Usage Statistics

If your team uses VS Code / Cursor, collect usage data through extensions:
...
Integrate AI-related quality metrics into CI/CD:
  ...
  collect-metrics:
    ...
    steps:
      - name: Check AI labels
        run: |
          # Check if PR contains AI assistance labels
          # Count code changes
          # Track subsequent bug rate
```
