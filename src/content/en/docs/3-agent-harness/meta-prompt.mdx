...
<Callout type="info">
The same flow works for generating an **AGENTS.md skeleton**: just replace "rules" with "project contract" (stack, commands, do-not-touch, conventions). See [AGENTS.md Cross-Tool Standard](/en/docs/3-agent-harness/agents-md) for the target structure.
</Callout>
...
- [Cursor Rules Best Practices](/en/docs/3-agent-harness/best-practices) - Core principles for rule writing
- [Rules and Conventions Across Development Phases](/en/docs/3-agent-harness/development-sequence) - When to write what rules
- [AGENTS.md Cross-Tool Standard](/en/docs/3-agent-harness/agents-md) - Generate the project contract with the same flow
...
After completing your Rules, let's move on to [Chapter 4: Workflow](/en/docs/4-workflow) to learn how to integrate these rules into your daily development process.
