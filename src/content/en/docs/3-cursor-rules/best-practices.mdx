...
<Callout type="info">
This article assumes you already understand [How Rules Work](./how-rules-work), including rule types, application methods, and file structure.
</Callout>
...
Split rule files by topic in `.cursor/rules/` directory, use `globs` to limit scope. For details on the four rule application methods, see [Rule Application Methods](./how-rules-work#rule-application-methods).
...
For complete `.mdc` file format specifications, see [Rule File Format Specification](./how-rules-work#rule-file-format-specification). A complete rule file typically contains these sections:
