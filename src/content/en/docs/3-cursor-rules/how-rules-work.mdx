...
After understanding how rules work, keep these points in mind when writing rules:

- 📏 **Control length** - Keep rules under 500 lines
- 🧩 **Split rules** - Break larger rules into multiple composable ones
- 📝 **Provide examples** - Include concrete examples or reference files
- 🎯 **Avoid ambiguity** - Write rules like clear internal documentation
- ♻️ **Reuse rules** - When reusing prompts in chat, reuse existing rules
