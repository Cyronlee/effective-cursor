...
| 3    | Agent Harness     | Systematically build the agent runtime environment | Define contracts with AGENTS.md/Rules, add deterministic constraints with Hooks, split work with Subagents, close the loop with verification |
...
2. Experienced users: Prioritize **3. Agent Harness** and **4. Workflow** for quick visible improvements.
