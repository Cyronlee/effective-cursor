...
This is the latest release, and while it has been tested, there may still be some issues that have not been discovered. If you encounter any anomalies or instability, please provide [Feedback](https://github.com/Cyronlee/effective-cursor/issues), and I will fix them as soon as possible.
</Callout>
...
- 🐞 Found an issue? Open an [Issue](https://github.com/Cyronlee/effective-cursor/issues)

### Roadmap

We'll continue optimizing framework performance and plan to add more useful features. Stay tuned!

If you find this project useful or like the work I’ve done, please consider clicking the [⭐️ Star](https://github.com/Cyronlee/effective-cursor) button to show your support! Each star motivates me to keep improving. Thank you! 😊
