---
title: "create-rule - Creating Cursor Rules"
---
...
<Callout type="info">
**Skill Name**: create-rule  
**Invocation**: Auto-triggered / `/create-rule`  
...
- **Under 500 lines**: Rules should be concise and to the point, shorter is better
...
- Ask about `.cursor/rules/` or `AGENTS.md`

## Related Documentation

- [Agent Harness Guide](/en/docs/3-agent-harness)
- [Rules Best Practices](/en/docs/3-agent-harness/best-practices)
- [Rules Templates](/en/rules)
