...
| Topic | Link | Use Case |
|-------|------|----------|
| AGENTS.md & Skills | [View](/en/docs/3-agent-harness/agents-md) | Understand project contracts vs task-level skills |
| Skills Best Practices | [View](/en/docs/3-agent-harness/agents-md) | Learn writing principles for Rules / AGENTS.md |
| Skill Examples | [View](/en/skills) | See real-world skill examples |
