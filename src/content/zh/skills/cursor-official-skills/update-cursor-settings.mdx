...
- **终端**: `terminal.integrated.fontSize`、`terminal.integrated.profiles.windows`（Windows 终端配置，如 Command Prompt/cmd.exe）、`terminal.integrated.profiles.osx`（macOS 终端配置，如 zsh）
...
- **Terminal**: `terminal.integrated.fontSize`, `terminal.integrated.profiles.windows` (e.g., Command Prompt), `terminal.integrated.profiles.osx` (e.g., zsh)
...
- **终端设置**: `terminal.integrated.fontSize`（终端字体大小）、`terminal.integrated.profiles.windows`（Windows 终端配置，如 Command Prompt/cmd.exe）、`terminal.integrated.profiles.osx`（macOS 终端配置，如 zsh）
