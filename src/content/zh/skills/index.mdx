...
| 主题 | 链接 | 适合场景 |
|-----|------|---------|
| AGENTS.md 与 Skills 分工 | [查看](/zh/docs/3-agent-harness/agents-md) | 了解项目契约与 Skills 的定位与组合 |
| Skills 编写最佳实践 | [查看](/zh/docs/3-agent-harness/agents-md) | 学习 Rules / AGENTS.md 的编写原则 |
| Skill 示例 | [查看](/zh/skills) | 查看实际的 Skill 案例 |
