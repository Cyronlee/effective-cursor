...
<Callout type="info">
**深入了解**：我们有一篇专门的文章介绍 [使用 Rules 管理记忆](/zh/docs/3-cursor-rules/memory-management)，包括本地记忆系统的实践方案。
</Callout>
...
<Callout type="info">
**我们的建议：** 对于大多数项目，Rules 就足够了。如果你有大量领域知识需要 AI 渐进式读取，可以考虑使用 [本地记忆系统](/zh/docs/3-cursor-rules/memory-management)。
</Callout>
