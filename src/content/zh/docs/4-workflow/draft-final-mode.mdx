...
生成详细的技术方案，输出到 @specs/001-order-export/final.md`}
</ChatExample>
...
我们的 Draft-Final 工作流体现了规范驱动开发（SDD）的原则，而无需依赖外部框架。了解更多关于[为什么不用 Spec 框架](./why-no-spec-framework)以及我们如何将这些原则适配到企业级场景中。

然后，让我们看看如何将所有模式整合到完整的[工作流实践](./workflow-practice)中。
